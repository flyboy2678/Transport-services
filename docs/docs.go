...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreateAccomodationPhotoPayload"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/store.AccomodationPhoto"
                        }
                    },
                    "400": {
        ...
        "/accomodationPhotos/accomodation/{id}": {
            "get": {
        ...
        "/accomodationPhotos/accomodationId/{id}": {
            "delete": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreateAccomodationPayload"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted",
                        "schema": {
                            "$ref": "#/definitions/store.Accomodation"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/store.Activity"
                        }
                    },
                    "404": {
                        "description": "Not Found",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreateActivityPayload"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/main.CreateActivityPhotoPayload"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted",
                        "schema": {
                            "$ref": "#/definitions/store.ActivityPhoto"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "main.CreateAccomodationPayload": {
            "type": "object",
            "required": [
                "description",
                "name",
        ...
        "main.CreateAccomodationPhotoPayload": {
            "type": "object",
            "required": [
                "accomodation_id",
                "photo_url"
        ...
        "main.CreateActivityPhotoPayload": {
            "type": "object",
            "required": [
                "accomodation_id",
                "photo_url"
